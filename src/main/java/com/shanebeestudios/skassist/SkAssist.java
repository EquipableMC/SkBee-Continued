package com.shanebeestudios.skassist;

import ch.njol.skript.Skript;
import com.shanebeestudios.skassist.api.bound.Bound;
import com.shanebeestudios.skassist.api.command.SkAssistInfo;
import com.shanebeestudios.skassist.api.structure.StructureManager;
import com.shanebeestudios.skassist.api.util.UpdateChecker;
import com.shanebeestudios.skassist.api.util.Util;
import com.shanebeestudios.skassist.api.wrapper.LazyLocation;
import com.shanebeestudios.skassist.config.BoundConfig;
import com.shanebeestudios.skassist.config.Config;
import com.shanebeestudios.skassist.elements.other.sections.SecRunTaskLater;
import com.shanebeestudios.skassist.elements.worldcreator.objects.BeeWorldConfig;
...
/**
 * Main class for SkAssist
 */
public class SkAssist extends JavaPlugin {
    ...
    // Earliest MC Version that SkAssist will support
    static final int[] EARLIEST_VERSION = new int[]{1, 18, 2};

    private static SkAssist instance;
    ...
    public void onEnable() {
        ...
        if (version.contains("-")) {
            ...
            Util.log("&ehttps://github.com/EquipableMC/SkAssist/issues");
        }
    ...
    private void loadCommands() {
        ...
        getCommand("skassist").setExecutor(new SkAssistInfo(this));
     ...
     */
    public static SkAssist getPlugin() {
        return instance;
    }
