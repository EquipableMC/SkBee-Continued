...
public class Util {
    ...
    private static final String PREFIX = "&7[&bSk&3Assist&7] ";
    private static final String PREFIX_ERROR = "&7[&bSk&3Assist &cERROR&7] ";
    ...
    public static void errorForAdmins(String format, Object... objects) {
        ...
        for (Player player : Bukkit.getOnlinePlayers()) {
            if (player.hasPermission("skassist.admin")) {
