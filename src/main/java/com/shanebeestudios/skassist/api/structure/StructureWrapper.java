package com.shanebeestudios.skassist.api.structure;
...
import com.shanebeestudios.skassist.api.wrapper.PDCWrapper;
...
public class StructureWrapper {
    ...
    public void save() {
        try {
            ...
            Util.skriptError("Could not save structure '%s', enable debug in SkAssist config for more info.", getName());
            if (SkAssist.getPlugin().getPluginConfig().SETTINGS_DEBUG) {
                e.printStackTrace();
            }
        }
    }
    ...
    public void delete() {
        try {
            ...
            Util.skriptError("Could not delete structure '%s', enable debug in SkAssist config for more info.", getName());
            if (SkAssist.getPlugin().getPluginConfig().SETTINGS_DEBUG) {
                e.printStackTrace();
            }
        }
     ...
     * <p>This is persistent, and will only work with SkAssist placing.</p>
     *
