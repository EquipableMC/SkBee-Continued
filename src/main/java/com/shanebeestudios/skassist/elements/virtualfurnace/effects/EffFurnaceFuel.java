package com.shanebeestudios.skassist.elements.virtualfurnace.effects;
...
public class EffFurnaceFuel extends Effect {
    ...
    private static final RecipeManager RECIPE_MANAGER = SkAssist.getPlugin().getVirtualFurnaceAPI().getRecipeManager();
