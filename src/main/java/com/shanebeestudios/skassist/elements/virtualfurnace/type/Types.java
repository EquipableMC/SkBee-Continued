package com.shanebeestudios.skassist.elements.virtualfurnace.type;
...
public class Types {
    ...
    public static final FurnaceManager FURNACE_MANAGER = SkAssist.getPlugin().getVirtualFurnaceAPI().getFurnaceManager();
