package com.shanebeestudios.skassist.elements.bound.expressions;
...
import com.shanebeestudios.skassist.api.bound.Bound.Axis;
import com.shanebeestudios.skassist.api.bound.Bound.Corner;
...
public class ExprBoundCoords extends PropertyExpression<Bound, Object> {
    ...
    public void change(Event e, Object[] delta, ChangeMode mode) {
        BoundConfig boundConfig = SkAssist.getPlugin().getBoundConfig();
