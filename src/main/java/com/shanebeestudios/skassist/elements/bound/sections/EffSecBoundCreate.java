package com.shanebeestudios.skassist.elements.bound.sections;
...
import com.shanebeestudios.skassist.api.event.bound.BoundCreateEvent;
import com.shanebeestudios.skassist.api.util.Util;
import com.shanebeestudios.skassist.api.util.WorldUtils;
import com.shanebeestudios.skassist.config.BoundConfig;
import com.shanebeestudios.skassist.api.bound.Bound;
import com.shanebeestudios.skassist.elements.bound.expressions.ExprLastCreatedBound;
...
public class EffSecBoundCreate extends EffectSection {
    ...
    static {
        boundConfig = SkAssist.getPlugin().getBoundConfig();
