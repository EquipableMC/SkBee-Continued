package com.shanebeestudios.skassist.elements.recipe.sections;
...
import com.shanebeestudios.skassist.api.event.recipe.ShapelessRecipeCreateEvent;
...
public class SecRecipeShapeless extends Section {
    ...
    private static final boolean DEBUG = SkAssist.getPlugin().getPluginConfig().SETTINGS_DEBUG;
