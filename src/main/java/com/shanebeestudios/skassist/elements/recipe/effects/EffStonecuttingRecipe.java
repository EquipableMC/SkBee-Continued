package com.shanebeestudios.skassist.elements.recipe.effects;
...
import com.shanebeestudios.skassist.api.recipe.RecipeUtil;
...
@Description({"Register a new stone cutting recipe.",
        ...
        "NOT SPACES!!! By default, if no namespace is provided, recipes will start with the namespace \"skassist:\",",
...
public class EffStonecuttingRecipe extends Effect {
    ...
    private final Config config = SkAssist.getPlugin().getPluginConfig();
