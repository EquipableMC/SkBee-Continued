package com.shanebeestudios.skassist.elements.recipe.expressions;
...
import com.shanebeestudios.skassist.elements.tag.type.Types;
...
public class ExprMaterialChoice extends SimpleExpression<MaterialChoice> {
    ...
    private static final boolean HAS_TAGS = SkAssist.getPlugin().getPluginConfig().ELEMENTS_MINECRAFT_TAG && Types.HAS_TAG;
