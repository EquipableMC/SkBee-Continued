package com.shanebeestudios.skassist.elements.other.expressions;
...
import com.shanebeestudios.skassist.api.util.ObjectConverter;
...
public class ExprNamespacedKeyObjectFrom extends SimpleExpression<Object> {
    ...
    public boolean init(Expression<?>[] exprs, int matchedPattern, Kleenean isDelayed, ParseResult parseResult) {
        ...
        if (this.objectConverter == null) {
            Skript.error("SkAssist does not have a NamespacedKey converter for '" + this.classInfo.toString() + "'");
            return false;
        }
        return true;
    }
