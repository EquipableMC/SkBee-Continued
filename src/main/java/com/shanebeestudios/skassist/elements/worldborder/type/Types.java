package com.shanebeestudios.skassist.elements.worldborder.type;
...
public class Types {
    ...
    static {
        if (Classes.getExactClassInfo(WorldBorder.class) == null) {
            ...
            Util.logLoading("You may have to use their worldborder in SkAssist's 'WorldBorder elements.");
        }
    }
}
