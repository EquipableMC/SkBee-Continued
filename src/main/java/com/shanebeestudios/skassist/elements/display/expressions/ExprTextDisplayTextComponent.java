package com.shanebeestudios.skassist.elements.display.expressions;
...
import com.shanebeestudios.skassist.api.wrapper.ComponentWrapper;
import com.shanebeestudios.skassist.elements.display.types.Types;
...
public class ExprTextDisplayTextComponent extends SimplePropertyExpression<Entity, ComponentWrapper> {
    ...
    static {
        if (SkAssist.getPlugin().getAddonLoader().isTextComponentEnabled()) {
