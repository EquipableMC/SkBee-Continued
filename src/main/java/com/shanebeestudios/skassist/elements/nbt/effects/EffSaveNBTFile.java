package com.shanebeestudios.skassist.elements.nbt.effects;
...
public class EffSaveNBTFile extends Effect {
    ...
    public static final boolean DEBUG = SkAssist.getPlugin().getPluginConfig().SETTINGS_DEBUG;
            ...
            if (compound instanceof NBTFile nbtFile) {
                try {
                    ...
                    if (DEBUG) {
                        ...
                        Util.skriptError("Could not save file: '" + nbtFile.getName() + "'. Enable debug in SkAssist config for more info");
                    }
                }
            }
        }
