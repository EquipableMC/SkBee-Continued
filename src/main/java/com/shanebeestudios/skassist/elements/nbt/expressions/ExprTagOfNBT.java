...
import com.shanebeestudios.skassist.api.nbt.NBTCustomType;
...
@Description({"Get/set/delete the value of the specified tag of an NBT compound. Also supports getting nested tags using a semi colon as a delimiter.",
    ...
    "- Entities/blocks can not natively hold custom NBT tags. SkAssist allows you to put custom nbt",
    ...
    "That said, this system is a tad convoluted, see the SkAssist WIKI for more details.",
