...
@Description({"Represents all loaded custom worlds created using SkAssist.",
...
public class ExprLoadedCustomWorlds extends SimpleExpression<World> {
    ...
    protected @Nullable World[] get(Event event) {
        return SkAssist.getPlugin().getBeeWorldConfig().getLoadedCustomWorlds().toArray(new World[0]);
    }
