package com.shanebeestudios.skassist.elements.worldcreator.effects;
...
@Description({"Load a world from a world creator.",
        "Worlds created/loaded with a world creator, are saved in the 'plugins/SkAssist/worlds.yml' file",
...
public class EffLoadWorld extends Effect {
    ...
    static {
        BEE_WORLD_CONFIG = SkAssist.getPlugin().getBeeWorldConfig();
