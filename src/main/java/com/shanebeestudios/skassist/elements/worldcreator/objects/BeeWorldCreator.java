package com.shanebeestudios.skassist.elements.worldcreator.objects;
...
public class BeeWorldCreator implements Keyed {
    ...
    public CompletableFuture<World> loadWorld() {
        ...
        worldCreatorCompletableFuture.thenAccept(worldCreator -> {
            ...
            SkAssist.getPlugin().getBeeWorldConfig().saveWorldToFile(this);
    ...
    private CompletableFuture<WorldCreator> cloneWorld() {
        ...
        Bukkit.getScheduler().runTaskAsynchronously(SkAssist.getPlugin(), () -> {
            ...
            if (worldDirectorToClone.exists()) {
                try {
                    ...
                    Bukkit.getScheduler().runTaskLater(SkAssist.getPlugin(), () -> {
