package com.shanebeestudios.skassist.elements.particle.type;
...
import com.shanebeestudios.skassist.api.particle.ParticleUtil;
...
public class Types {
    ...
    static {
        ...
        if (Classes.getExactClassInfo(Particle.class) == null) {
            ...
            Util.logLoading("You may have to use their particles in SkAssist's 'particle spawn' effect.");
        }
