package com.shanebeestudios.skassist.elements.villager.type;
...
public class Types {
    ...
    static {
        ...
        if (Classes.getExactClassInfo(Profession.class) == null) {
            ...
            Util.logLoading("You may have to use their profession in SkAssist's 'Villager Profession' expression.");
        }
        ...
        if (Classes.getExactClassInfo(Type.class) == null) {
            ...
            Util.logLoading("You may have to use their villagertype in SkAssist's 'Villager Type' expression.");
        }
