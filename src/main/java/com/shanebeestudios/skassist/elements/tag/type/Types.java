package com.shanebeestudios.skassist.elements.tag.type;
...
public class Types {
    ...
    static {
        if (Classes.getExactClassInfo(Tag.class) == null) {
            ...
            Util.logLoading("You may have to use their Minecraft Tags in SkAssist's Minecraft Tag expressions.");
        }
    }
