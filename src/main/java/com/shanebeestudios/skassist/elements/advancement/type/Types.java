package com.shanebeestudios.skassist.elements.advancement.type;
...
public class Types {
    ...
    static {
        ...
        if (Classes.getExactClassInfo(Advancement.class) == null) {
            ...
            Util.logLoading("You may have to use their advancements in SkAssist's 'advancement' elements.");
        }
        ...
        if (Classes.getExactClassInfo(AdvancementProgress.class) == null) {
            ...
            Util.logLoading("You may have to use their advancement progresses in SkAssist's 'advancement' elements.");
        }
    }
