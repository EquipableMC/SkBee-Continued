package site.equipable.skassist.elements.bound.expressions;
...
public class ExprBoundCoords extends PropertyExpression<Bound, Object> {
    ...
    public void change(Event e, Object[] delta, ChangeMode mode) {
        ...
        for (Bound bound : getExpr().getArray(e)) {
            ...
            Bound.Corner corner = LESSER ? Bound.Corner.LESSER : Bound.Corner.GREATER;
            Bound.Axis axis = parse == 0 ? Bound.Axis.X : parse == 1 ? Bound.Axis.Y : Bound.Axis.Z;
