package site.equipable.skassist.elements.other.type;
...
import site.equipable.skassist.api.util.ItemUtils;
import site.equipable.skassist.api.util.MathUtil;
import site.equipable.skassist.api.util.SkriptUtils;
import site.equipable.skassist.api.util.Util;
import site.equipable.skassist.api.wrapper.EnumWrapper;
import site.equipable.skassist.api.wrapper.RegistryClassInfo;
...
public class Types {
    ...
    static {
        if (Classes.getExactClassInfo(ItemFlag.class) == null) {
            ...
            Util.logLoading("You may have to use their ItemFlags in SkAssist's 'Item Flags' expressions.");
        }
        ...
        if (Classes.getExactClassInfo(Spellcaster.Spell.class) == null) {
            ...
            Util.logLoading("You may have to use their spells in SkAssist's 'Spell-caster Spell' expression.");
        }
        ...
        if (Classes.getExactClassInfo(Cause.class) == null) {
            ...
            Util.logLoading("You may have to use their potion effect causes in SkAssist's 'Entity Potion Effect' event.");
        }
        ...
        if (Classes.getExactClassInfo(EntityEffect.class) == null) {
            ...
            Util.logLoading("You may have to use their EntityEffects in SkAssist's 'play entity effect' effect.");
        }
