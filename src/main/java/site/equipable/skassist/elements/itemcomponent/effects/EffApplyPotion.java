package site.equipable.skassist.elements.itemcomponent.effects;
...
import site.equipable.skassist.elements.itemcomponent.sections.SecFoodComponent;
...
public class EffApplyPotion extends Effect {
    ...
    protected void execute(Event event) {
        if (event instanceof SecFoodComponent.FoodComponentApplyEvent applyEvent) {
