package site.equipable.skassist.elements.worldcreator.expressions;
...
import site.equipable.skassist.elements.worldcreator.objects.BeeWorldCreator;
...
@Description({"Set different options for world creators. See SkAssist wiki for more details.",
        "\nNOTE: 'load on start' will bypass 'auto-load-custom-worlds' in SkAssist config."})
