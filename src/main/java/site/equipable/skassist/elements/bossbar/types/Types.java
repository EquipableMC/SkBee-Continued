package site.equipable.skassist.elements.bossbar.types;
...
public class Types {
    ...
    static {
        if (Classes.getExactClassInfo(BossBar.class) == null) {
            ...
            Util.logLoading("&eYou may have to use their BossBars in SkAssist's BossBar elements.");
        }
        ...
        if (Classes.getExactClassInfo(BarStyle.class) == null && Classes.getClassInfoNoError("bossbarstyle") == null) {
            ...
            Util.logLoading("&eYou may have to use their BossBar styles in SkAssist's BossBar elements.");
        }
        ...
        if (Classes.getExactClassInfo(BarFlag.class) == null && Classes.getClassInfoNoError("bossbarflag") == null) {
            ...
            Util.logLoading("&eYou may have to use their BossBar flags in SkAssist's BossBar elements.");
        }
    }
